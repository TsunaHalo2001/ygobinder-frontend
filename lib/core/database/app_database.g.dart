...
class $WantedCardsTable extends WantedCards
    with TableInfo<$WantedCardsTable, DriftWantedCard> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $WantedCardsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _cardIdMeta = const VerificationMeta('cardId');
  @override
  late final GeneratedColumn<int> cardId = GeneratedColumn<int>(
    'card_id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'wanted_cards';
  @override
  VerificationContext validateIntegrity(
    Insertable<DriftWantedCard> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {cardId};
  @override
  DriftWantedCard map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DriftWantedCard(
      cardId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}card_id'],
      )!,
  ...
  @override
  $WantedCardsTable createAlias(String alias) {
    return $WantedCardsTable(attachedDatabase, alias);
  }
}

class DriftWantedCard extends DataClass implements Insertable<DriftWantedCard> {
  final int cardId;
  final String? syncId;
  final DateTime createdAt;
  final DateTime updatedAt;
  const DriftWantedCard({
    required this.cardId,
    this.syncId,
    required this.createdAt,
    required this.updatedAt,
  ...
  WantedCardsCompanion toCompanion(bool nullToAbsent) {
    return WantedCardsCompanion(
      cardId: Value(cardId),
      syncId: syncId == null && nullToAbsent
          ? const Value.absent()
          : Value(syncId),
  ...
  factory DriftWantedCard.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  DriftWantedCard copyWithCompanion(WantedCardsCompanion data) {
    return DriftWantedCard(
      cardId: data.cardId.present ? data.cardId.value : this.cardId,
      syncId: data.syncId.present ? data.syncId.value : this.syncId,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
  ...
  @override
  String toString() {
    return (StringBuffer('DriftWantedCard(')
          ..write('cardId: $cardId, ')
          ..write('syncId: $syncId, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt')
...
class WantedCardsCompanion extends UpdateCompanion<DriftWantedCard> {
  final Value<int> cardId;
  final Value<String?> syncId;
  final Value<DateTime> createdAt;
  final Value<DateTime> updatedAt;
  const WantedCardsCompanion({
    this.cardId = const Value.absent(),
    this.syncId = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
  ...
  static Insertable<DriftWantedCard> custom({
    Expression<int>? cardId,
    Expression<String>? syncId,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('WantedCardsCompanion(')
          ..write('cardId: $cardId, ')
          ..write('syncId: $syncId, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt')
...
class $CurrencyRatesTable extends CurrencyRates
    with TableInfo<$CurrencyRatesTable, DriftCurrencyRate> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _rateToUsdMeta = const VerificationMeta(
    'rateToUsd',
  );
  @override
  late final GeneratedColumn<double> rateToUsd = GeneratedColumn<double>(
    'rate_to_usd',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  @override
  List<GeneratedColumn> get $columns => [currencyCode, rateToUsd, lastUpdated];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<DriftCurrencyRate> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('rate_to_usd')) {
      context.handle(
        _rateToUsdMeta,
        rateToUsd.isAcceptableOrUnknown(data['rate_to_usd']!, _rateToUsdMeta),
      );
    } else if (isInserting) {
      context.missing(_rateToUsdMeta);
    }
    if (data.containsKey('last_updated')) {
      context.handle(
        _lastUpdatedMeta,
  ...
  @override
  DriftCurrencyRate map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DriftCurrencyRate(
      currencyCode: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}currency_code'],
      )!,
      rateToUsd: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}rate_to_usd'],
      )!,
      lastUpdated: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}last_updated'],
...
class DriftCurrencyRate extends DataClass
    implements Insertable<DriftCurrencyRate> {
  final String currencyCode;
  final double rateToUsd;
  final DateTime lastUpdated;
  const DriftCurrencyRate({
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['rate_to_usd'] = Variable<double>(rateToUsd);
  ...
  factory DriftCurrencyRate.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DriftCurrencyRate(
      ...
      rateToUsd: serializer.fromJson<double>(json['rateToUsd']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'rateToUsd': serializer.toJson<double>(rateToUsd),
      'lastUpdated': serializer.toJson<DateTime>(lastUpdated),
    };
  }

  DriftCurrencyRate copyWith({
    String? currencyCode,
    double? rateToUsd,
  ...
  DriftCurrencyRate copyWithCompanion(CurrencyRatesCompanion data) {
    return DriftCurrencyRate(
      currencyCode: data.currencyCode.present
          ? data.currencyCode.value
          : this.currencyCode,
      rateToUsd: data.rateToUsd.present ? data.rateToUsd.value : this.rateToUsd,
      lastUpdated: data.lastUpdated.present
          ? data.lastUpdated.value
          : this.lastUpdated,
    );
  ...
  @override
  String toString() {
    return (StringBuffer('DriftCurrencyRate(')
          ..write('currencyCode: $currencyCode, ')
          ..write('rateToUsd: $rateToUsd, ')
          ..write('lastUpdated: $lastUpdated')
          ..write(')'))
        .toString();
  }
  ...
  @override
  int get hashCode => Object.hash(currencyCode, rateToUsd, lastUpdated);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DriftCurrencyRate &&
          other.currencyCode == this.currencyCode &&
          other.rateToUsd == this.rateToUsd &&
          other.lastUpdated == this.lastUpdated);
}

class CurrencyRatesCompanion extends UpdateCompanion<DriftCurrencyRate> {
  final Value<String> currencyCode;
  final Value<double> rateToUsd;
  final Value<DateTime> lastUpdated;
  final Value<int> rowid;
  const CurrencyRatesCompanion({
    this.currencyCode = const Value.absent(),
    this.rateToUsd = const Value.absent(),
    this.lastUpdated = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  CurrencyRatesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       rateToUsd = Value(rateToUsd);
  static Insertable<DriftCurrencyRate> custom({
    Expression<String>? currencyCode,
    Expression<double>? rateToUsd,
    Expression<DateTime>? lastUpdated,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (currencyCode != null) 'currency_code': currencyCode,
      if (rateToUsd != null) 'rate_to_usd': rateToUsd,
      if (lastUpdated != null) 'last_updated': lastUpdated,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (rateToUsd.present) {
      map['rate_to_usd'] = Variable<double>(rateToUsd.value);
    }
    if (lastUpdated.present) {
...
typedef $$FavoriteCardsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$WantedCardsTableCreateCompanionBuilder =
    WantedCardsCompanion Function({
      Value<int> cardId,
      Value<String?> syncId,
      Value<DateTime> createdAt,
      Value<DateTime> updatedAt,
    });
typedef $$WantedCardsTableUpdateCompanionBuilder =
    WantedCardsCompanion Function({
      Value<int> cardId,
      Value<String?> syncId,
      Value<DateTime> createdAt,
...
class $$WantedCardsTableFilterComposer
    extends Composer<_$AppDatabase, $WantedCardsTable> {
  $$WantedCardsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WantedCardsTableOrderingComposer
    extends Composer<_$AppDatabase, $WantedCardsTable> {
  $$WantedCardsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WantedCardsTableAnnotationComposer
    extends Composer<_$AppDatabase, $WantedCardsTable> {
  $$WantedCardsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$WantedCardsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $WantedCardsTable,
          ...
          $$WantedCardsTableOrderingComposer,
          $$WantedCardsTableAnnotationComposer,
          $$WantedCardsTableCreateCompanionBuilder,
          $$WantedCardsTableUpdateCompanionBuilder,
          (
            DriftWantedCard,
            BaseReferences<_$AppDatabase, $WantedCardsTable, DriftWantedCard>,
          ),
          DriftWantedCard,
          PrefetchHooks Function()
        > {
  $$WantedCardsTableTableManager(_$AppDatabase db, $WantedCardsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$WantedCardsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$WantedCardsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$WantedCardsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> cardId = const Value.absent(),
                Value<String?> syncId = const Value.absent(),
...
typedef $$WantedCardsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $WantedCardsTable,
      DriftWantedCard,
...
class $$CurrencyRatesTableFilterComposer
  ...
  ColumnFilters<double> get rateToUsd => $composableBuilder(
    column: $table.rateToUsd,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CurrencyRatesTableOrderingComposer
  ...
  ColumnOrderings<double> get rateToUsd => $composableBuilder(
    column: $table.rateToUsd,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CurrencyRatesTableAnnotationComposer
  ...
  GeneratedColumn<double> get rateToUsd =>
      $composableBuilder(column: $table.rateToUsd, builder: (column) => column);
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<double> rateToUsd = const Value.absent(),
...
typedef $$CurrencyRatesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        DriftCurrencyRate,
        BaseReferences<_$AppDatabase, $CurrencyRatesTable, DriftCurrencyRate>,
      ),
      DriftCurrencyRate,
      PrefetchHooks Function()
    >;
